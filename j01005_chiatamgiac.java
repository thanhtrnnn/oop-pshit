...
public class j01005_chiatamgiac {
    public static void main(String[] args) throws IOException {
        ...
        int t = sc.nint();
        while (t-- > 0) {
            int n = sc.nint(), h = sc.nint();
            for (int i = 1; i < n; i++) {
                // Calculate the height at the i-th division
                // area ratio curr triangle/ total triangle = (curh/h)^2 = (i/n)^2
                double curh = ((double)h * Math.sqrt((double) i / n));
